...
* @returns {string}
*/
module.exports.process_ga1 = function(data) {
    try {
...
* @returns {number}
*/
module.exports.batch_size = function() {
...
* @param {number} rng
*/
module.exports.random_generator_free = function(rng) {
...
* @returns {number}
*/
module.exports.threshold_signer = function(session, player_index, player_count, threshold, share, pubkey) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @param {number} signer
*/
module.exports.threshold_signer_free = function(signer) {
...
* @returns {Promise<any>}
*/
module.exports.setup = function(signer, rng) {
...
* @returns {Promise<any>}
*/
module.exports.precompute = function(parties, signer, rng) {
...
* @returns {any}
*/
module.exports.local_sign = function(msg, hash_only, precompute) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
module.exports.get_r_from_precompute = function(precompute) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
module.exports.local_verify = function(msg, hash_only, r, sig_frags, pubkey) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(msg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {Promise<any>}
*/
module.exports.sign = function(counterparties, msg, hash_only, signer, rng) {
    const ptr0 = passStringToWasm0(msg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
module.exports.__wbg_jsreadmsg_c78b36111e71b2d6 = function(arg0, arg1, arg2, arg3, arg4, arg5) {
    try {
