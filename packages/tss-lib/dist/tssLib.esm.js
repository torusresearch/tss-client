...
function wasmData(imports){return _loadWasmModule(0, '55e8e0c354074d31.wasm', null, imports)}
...
function __wbg_adapter_24(arg0, arg1, arg2) {
  wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h393860affdd597ff(arg0, arg1, addHeapObject(arg2));
}
 ...
 * @returns {number}
 */
function random_generator(state) {
  try {
 ...
 * @param {number} rng
 */
function random_generator_free(rng) {
 ...
 * @returns {number}
 */
function threshold_signer(session, player_index, player_count, threshold, share, pubkey) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @param {number} signer
 */
function threshold_signer_free(signer) {
 ...
 * @returns {Promise<any>}
 */
function precompute(parties, signer, rng) {
 ...
 * @returns {any}
 */
function local_sign(msg, hash_only, precompute) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {any}
 */
function get_r_from_precompute(precompute) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {any}
 */
function local_verify(msg, hash_only, r, sig_frags, pubkey) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(msg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function sign(counterparties, msg, hash_only, signer, rng) {
  const ptr0 = passStringToWasm0(msg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
  const len0 = WASM_VECTOR_LEN;
...
export { WasmBindgenTestContext, __wbgtest_console_debug, __wbgtest_console_error, __wbgtest_console_info, __wbgtest_console_log, __wbgtest_console_warn, batch_size, init as default, finalizeInit, getImports, get_r_from_precompute, initSync, local_sign, local_verify, precompute, random_generator, random_generator_free, setup, sign, threshold_signer, threshold_signer_free };
//# sourceMappingURL=tssLib.esm.js.map
